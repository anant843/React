...
const CompleteTask = ({ data }) => {
  return (
    <div className="flex-shrink-0 h-full w-[340px] p-6 bg-gradient-to-br from-rose-500 to-red-600 rounded-2xl shadow-xl hover:shadow-red-500/30 hover:-translate-y-2 transition-all duration-300 border border-red-300/20">
      ...
      <p className="text-sm mt-3 text-red-100 leading-6">
